...
# Configuration
plugin="PulseSoftcam_Updater-plugins"
version="1.0"
url="https://raw.githubusercontent.com/Ham-ahmed/21F/refs/heads/main/PulseSoftcam_Updater.tar.gz"
