...
echo -e "${CYAN}"
echo "################################################################"
echo "#     Start downloading and installing crashlogviewer_1.8       #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/21F/refs/heads/main/enigma2-plugin-extensions-crashlogviewer_1.8_all.ipk"
IPK_NAME="enigma2-plugin-extensions-crashlogviewer_1.8_all.ipk"
